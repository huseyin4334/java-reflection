package com.java.reflection.getClass;

import com.java.reflection.getClass.models.Car;
...
public class App {
    ...
    private static void nonPrimitiveTypeClass() {
        ...
        String className = "com.java.reflection.getClass.models.Car";
    ...
    private static void classForName() {
        try {
            // find a class
            Class<?> carClass = Class.forName("com.java.reflection.getClass.models.Car");
            System.out.println(carClass.getSimpleName());
            ...
            // innerclass
            Class<Car.Engine> engineClass = (Class<Car.Engine>) Class.forName("com.java.reflection.getClass.models.Car$Engine");
